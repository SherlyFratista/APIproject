...
<div class="container div-articles">
    ...
    <div class="col-md-7">
      <div class="row">
        <div class="col-md-10 col-sm-10 col-xs-8">
          <h3 class="title-article"><a href="#">Pizza 1</a></h3>
          <p class="author-article">by <a href="#">Sherly Fratista</a></p>
  ...
  <div class="row div-single-articles">
    <div class="col-md-5">
      <img src="img/recent/2.jpg" class="img-responsive">
    </div>
    <div class="col-md-7">
      <div class="row">
        <div class="col-md-10 col-sm-10 col-xs-8">
          <h3 class="title-article"><a href="#">Pizza 2</a></h3>
          <p class="author-article">by <a href="#">Sherly Fratista</a></p>
